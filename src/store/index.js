...
const store = new Vuex.Store({
  state: {
    componentList: [
      ...
      {type: "img", title: '图片附件', id: 11},
      {type: "file", title: '文档附件', id: 12},
    ],
    canvasList: [
      {type: "text", title: '单行文本', placeholder: '', defaultValue: '', id: 101},
      ...
      {type: "img", title: '图片附件', id: 111},
      {type: "file", title: '文档附件', id: 112},
    ]
  },
  mutations: {
